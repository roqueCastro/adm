...
<body>
    ...
    <header id="topnav">
        ...
        <!-- End Navigation Bar-->
        <!-------------------- donde va la tabla completa de la consulta----------------->
        <div class="wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12">
                        <div class="card m-b-30">
                            <div class="card-body">
                                ...
                                <!-- TABLE -->
                                <table id="tabla" class="table table-striped table-bordered teb" cellspacing="0" width="100%">
                                    <thead>
                                        <tr>
                                            <th>
                                                Pregunta
        ...
        <!--------------------END donde va la tabla completa de la consulta----------------->
        <!-- jQuery  -->
