...
<body>
    ...
    <form class="" method="POST" action="">
        <div class="form-group">
            <label>Nombre del tipo pregunta</label>
            <div>
                <textarea id="nombre_tipo_pre" required class="form-control" rows="5"></textarea>
            </div>
         </div>
        ...
        <div class="form-group">
            <div>
                <button type="button" onclick="Registrar_Tipo_Pre()" class="btn btn-primary">
                    Enviar
                </button>
...
<!-- JS para codigo MVC -->
<script src="js/tipo_preguntas.js" type="text/javascript"></script>
