...
<body>
    ...
    <form class="" method="POST" action="">
        <div class="form-group">
            ...
            <div class="form-group">
                <select id="tipo_encuesta" required class="form-control">
        ...
        <div class="form-group">
            ...
            <div class="form-group">
                <select id="tipo_pregunta" required class="form-control">
        ...
        <div class="form-group">
            <div>
                <button type="button" onclick="Registrar_Pregunta()" class="btn btn-primary">
                    Enviar
                </button>
