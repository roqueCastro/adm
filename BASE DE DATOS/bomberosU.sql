...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 21-09-2018 a las 15:58:00
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `seguimiento_table`  AS  select `segui`.`evento` AS `ID`,`segui`.`descripcion` AS `DESCRIPCION`,`segui`.`fecha` AS `FECHA` from `seguimiento` `segui` ;
...
--
ALTER TABLE `evento`
  MODIFY `id_evento` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=583;
--
